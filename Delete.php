...
if(isset($_POST) & !empty($_POST)){
 	$prodid = mysqli_real_escape_string($connection2, $_POST['prodid']);
 	
 	$sql = "DELETE FROM `Product`  WHERE prodID = '$prodid'";
 	$result2 = mysqli_query($connection2, $sql);
 	if($result2){
 		$smsg2 =  "Product Deleted";
 	}else{
 		$fmsg2 = "Product Not Deleted";
 	}
}
...
<body>
	  <div class="container">
         ...
         <h2 class="form-signin-heading">Delete Inventory</h2>
         <div class="input-group">
	         <span class="input-group-addon" id="basic-addon1"></span>
	         <input type="text" name="prodid" class="form-control" placeholder="Product ID" required>
	     </div>
